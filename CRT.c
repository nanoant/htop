...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [CPU_TEMP] = ColorPair(Blue,Black),
      [CPU_TEMP_HOT] = ColorPair(Red,Black),
      [CPU_TEMP_WARM] = ColorPair(Yellow,Black),
      [CPU_TEMP_NORMAL] = ColorPair(Green,Black),
      [FAN_RPM] = ColorPair(Blue,Black),
      [FAN_RPM_HOT] = ColorPair(Red,Black),
      [FAN_RPM_WARM] = ColorPair(Yellow,Black),
      [FAN_RPM_NORMAL] = ColorPair(Green,Black),
   },
   [COLORSCHEME_MONOCHROME] = {
      ...
      [CPU_TEMP] = A_BOLD,
      [CPU_TEMP_HOT] = A_BOLD,
      [CPU_TEMP_WARM] = A_BOLD,
      [CPU_TEMP_NORMAL] = A_NORMAL,
      [FAN_RPM] = A_BOLD,
      [FAN_RPM_HOT] = A_BOLD,
      [FAN_RPM_WARM] = A_BOLD,
      [FAN_RPM_NORMAL] = A_NORMAL,
   },
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [CPU_TEMP] = ColorPair(Blue,Blue),
      [CPU_TEMP_HOT] = ColorPair(Red,Blue),
      [CPU_TEMP_WARM] = ColorPair(Yellow,Blue),
      [CPU_TEMP_NORMAL] = ColorPair(Green,Blue),
      [FAN_RPM] = ColorPair(Blue,Blue),
      [FAN_RPM_HOT] = ColorPair(Red,Blue),
      [FAN_RPM_WARM] = ColorPair(Yellow,Blue),
      [FAN_RPM_NORMAL] = ColorPair(Green,Blue),
   },
